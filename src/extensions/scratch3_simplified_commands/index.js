...
class ScratchSimplifiedCommandsBlocks {
    ...
    gotoLeft(args, util){
        util.target.setXY(util.target.x - this.cell_length * args.N_CELLS, util.target.y);
    }
    ...
    gotoUp(args, util){
        util.target.setXY(util.target.x, util.target.y + this.cell_length * args.N_CELLS);
    }
    ...
    getInfo() {
        return {
            id: 'TechLAB4KidsBlocksSimplifiedBlocks',
